    ...
    <div className="space-y-6 text-muted-foreground pb-10">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-2 text-sm">
          <li>
            <strong className="text-foreground">number:</strong> {t('docs.scalar')}
          </li>
          <li>
            <strong className="text-foreground">vector:</strong> {t('docs.vector')}
          </li>
          <li>
            <strong className="text-foreground">matrix:</strong> {t('docs.matrix')}
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          {advancedMathItems.map((item) => (
            <div
              key={item.id}
              className="border border-border rounded-lg overflow-hidden bg-card/50 shadow-sm transition-all hover:border-primary/50"
            >
              <button
