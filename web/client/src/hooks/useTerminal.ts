...
export const useTerminal = () => {
    ...
    useEffect(() => {
        ...
        const handleConnect = () => {
            setState(prev => ({ ...prev, isConnected: true, history: [...prev.history, '[System] Connected to MPL Live Interpreter.'] }));
        };

        const handleDisconnect = () => {
            setState(prev => ({ ...prev, isConnected: false, history: [...prev.history, '[System] Disconnected from Interpreter.'] }));
        };
        ...
        return () => {
            ...
            socketService.off('error_output');
            socketService.off('closed');
